...
//Various settings
float pid_p_gain = 22;   //35                                     //Gain setting for the P-controller
float pid_i_gain = 0.4; //1.0                                     //Gain setting for the I-controller
float pid_d_gain = 60;   //60                                      //Gain setting for the D-controller

////////////////////////////////////
int flag = 0;                                                //Variable needed to acquire the calibration value of the IMU

#define L 0.200f                                             // distance between the two wheels of the robot
